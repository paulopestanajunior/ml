...
* *DS para Negócios*, capítulo 2 – apresenta o ciclo completo de data science até a implantação, enfatizando que o processo termina na **deployment**【681657430915828†L53-L66】.
...
- [ ] Mapear como as etapas do processo de data science (business understanding, data understanding, preparation, modeling, evaluation e deployment) se relacionam com práticas de MLOps【681657430915828†L53-L66】.
...
* *Hands‑On LLM* – seções finais que mostram como construir pipelines e interfaces de serviço com LLMs, bem como integrar modelos com APIs e bancos de dados【51140306659036†L25-L49】.
...
* *DS para Negócios*, capítulo 7 – discute esperanças e valor esperado como critérios de avaliação e decisão, levando em conta custos e benefícios【681657430915828†L174-L190】.
...
- [ ] Usar a estrutura de **valor esperado** para decidir se vale a pena implementar o pipeline: calcular retorno financeiro esperado para cada decisão, considerando economias de tempo, satisfação do usuário e possíveis receitas geradas【681657430915828†L174-L190】.
...
* Artigo da **Snorkel AI** – menciona que a observabilidade deve monitorar a **segurança** das respostas, garantindo que conteúdos indevidos sejam detectados【658830042717487†L72-L97】.
...
* *DS para Negócios*, capítulo 7 – descreve o uso de **expected value** e matriz de custos e benefícios para decidir se um modelo deve ser implementado e como investir em melhorias【681657430915828†L174-L190】.
...
- [ ] Aplicar o framework de valor esperado do *DS para Negócios* para avaliar uma ou duas ideias.  Anotar quais suposições você está fazendo (volumes de uso, preços de serviço, conversão em receita)【681657430915828†L174-L190】.
